...
from app.servicios.usuarioServicio import obtener_usuario_por_nombre, eliminar_usuario, actualizar_usuario
...
def actualizar_usuario_controlador():
    ...
    if actualizar_usuario(id_usuario, contrasena, edad, genero):
