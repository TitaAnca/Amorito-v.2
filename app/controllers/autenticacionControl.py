...
>>>>>>> 2429fbab6e5fb1c55bf246b4ca18fe6153a02677
...
def registrar_usuario_controlador():
    ...
    # Validar la entrada
    if not datos.get("nombre_usuario") or not datos.get("contrasena") or not datos.get("edad") or not datos.get("genero"):
    ...
    if registrar_usuario(nombre_usuario, contrasena, edad, genero):
